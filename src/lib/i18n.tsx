...
export const translations = {
  es: {
    ...
    hero_subtitle: 'Flota de lujo, entrega en el aeropuerto, millas ilimitadas y seguro incluido. La experiencia premium de alquiler de autos en Miami.',
    ...
    feat1_title: 'Flota Premium',
    feat1_desc: 'Más de 15 vehículos de alta gama, desde sedanes ejecutivos hasta exóticos de lujo.',
    ...
    feat4_desc: 'Planes de seguro desde básico hasta premium. Manejá tranquilo en todo momento.',
  ...
  en: {
    ...
    hero_subtitle: 'Luxury fleet, airport delivery, unlimited miles and insurance included. The premium car rental experience in Miami.',
    ...
    feat1_title: 'Premium Fleet',
    feat1_desc: 'Over 15 high-end vehicles, from executive sedans to luxury exotics.',
    ...
    feat4_desc: 'Insurance plans from basic to premium. Drive with peace of mind.',
